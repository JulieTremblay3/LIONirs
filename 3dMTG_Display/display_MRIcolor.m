    ...
    if PMI{currentsub}.data(cf).MeasListAct(ch)& ml(ch,1)~= 0;
        ...
        if ~isempty(pSrs)&~isempty(pDet)
            ...
            %transfert sur le cortex.
                ...
                y_srs = vHoles(pSrs).Coord.y-vHoles(pSrs).Normal.y*vHoles(pSrs).SkinDepth;
                z_srs = vHoles(pSrs).Coord.z-vHoles(pSrs).Normal.z*vHoles(pSrs).SkinDepth;
                x_det = vHoles(pDet(1)).Coord.x-vHoles(pDet(1)).Normal.x*vHoles(pDet(1)).SkinDepth;
                y_det = vHoles(pDet(1)).Coord.y-vHoles(pDet(1)).Normal.y*vHoles(pDet(1)).SkinDepth;
                z_det = vHoles(pDet(1)).Coord.z-vHoles(pDet(1)).Normal.z*vHoles(pDet(1)).SkinDepth;
            end
    ...
    if PMI{currentsub}.data(cf).MeasListAct(ch)& ml(ch,1)~= 0;
        ...
        if ~isempty(pSrs)&~isempty(pDet)
            ...
            %transfert sur le cortex.
                ...
                x_det = vHoles(pDet(1)).Coord.x-vHoles(pDet(1)).Normal.x*vHoles(pDet(1)).SkinDepth;
                z_det = vHoles(pDet(1)).Coord.y-vHoles(pDet(1)).Normal.y*vHoles(pDet(1)).SkinDepth;
                y_det = vHoles(pDet(1)).Coord.z-vHoles(pDet(1)).Normal.z*vHoles(pDet(1)).SkinDepth;
            end
            [theta_srs,phi_srs,r_srs]= cart2sph(x_srs,y_srs,z_srs);
            [theta_det,phi_det,r_det]= cart2sph(x_det,y_det,z_det);
            if theta_srs * theta_det < 0
    ...
    if PMI{currentsub}.data(cf).MeasListAct(ch)& ml(ch,1)~= 0;
        ...
        if ~isempty(pSrs)&~isempty(pDet)
            ...
            %transfert sur le cortex.
                ...
                z_det = vHoles(pDet(1)).Coord.x-vHoles(pDet(1)).Normal.x*vHoles(pDet(1)).SkinDepth;
                y_det = vHoles(pDet(1)).Coord.y-vHoles(pDet(1)).Normal.y*vHoles(pDet(1)).SkinDepth;
                x_det = vHoles(pDet(1)).Coord.z-vHoles(pDet(1)).Normal.z*vHoles(pDet(1)).SkinDepth;
            end
            [theta_srs,phi_srs,r_srs]= cart2sph(x_srs,y_srs,z_srs);
            [theta_det,phi_det,r_det]= cart2sph(x_det,y_det,z_det);
            if theta_srs * theta_det < 0
