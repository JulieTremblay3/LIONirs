...
im(:,:,1) = reshape(round(RGBA(3:4:end)),round(widthSS),round(heightSS)).';
im(:,:,2) = reshape(round(RGBA(2:4:end)),round(widthSS),round(heightSS)).';
im(:,:,3) = reshape(round(RGBA(1:4:end)),round(widthSS),round(heightSS)).';
