...
%-----------------------------------------------------------------------
matlabbatch{1}.spm.tools.nirsHSJ.M_Utility.E_NIRSmatdiradjust.NIRSmat = '<UNDEFINED>';
...
matlabbatch{2}.spm.tools.nirsHSJ.M_Utility.E_NIRSmatcreatenewbranch.e_NIRSmatdirnewbranch = '<UNDEFINED>'; %'AvgBL';
...
matlabbatch{3}.spm.tools.nirsHSJ.M_preprocessing.E_average.choiceave.trigger ='<UNDEFINED>'; % 1;
