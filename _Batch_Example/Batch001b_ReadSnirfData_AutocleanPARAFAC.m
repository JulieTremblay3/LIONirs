%-----------------------------------------------------------------------
% Job saved on 21-May-2026 10:27:02 by cfg_util (rev $Rev: 6942 $)
% spm SPM - SPM12 (7219)
...
matlabbatch{1}.spm.tools.nirsHSJ.M_readNIRS.E_readSNIRF.c_createImportProjectSnirf.b_importProject.prjfile = {'C:\Data\ToolboxLIONirs\TutorialHandsOn2026_Visual\dan107_allatlasbrodmann.prj'};
matlabbatch{1}.spm.tools.nirsHSJ.M_readNIRS.E_readSNIRF.output_path = 'C:\Data\ToolboxLIONirs\TutorialHandsOn2026_Visual\C01';
...
matlabbatch{2}.spm.tools.nirsHSJ.M_preprocessing.E_artefactdetection.b_meandiff.m_thresholdstepzscore = 2;
...
matlabbatch{3}.spm.tools.nirsHSJ.M_dataComponent.E_extractcomponent.c_extractcomponent.b_extractnoise_PARAFAC.NIRSmat(1) = cfg_dep('Artifact Detection: NIRS.mat', substruct('.','val', '{}',{2}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','NIRSmat'));
matlabbatch{3}.spm.tools.nirsHSJ.M_dataComponent.E_extractcomponent.c_extractcomponent.b_extractnoise_PARAFAC.i_extractnoise_labelPARAFAC = 'MVTPARAFAC';
matlabbatch{3}.spm.tools.nirsHSJ.M_dataComponent.E_extractcomponent.c_extractcomponent.b_extractnoise_PARAFAC.m_extractcomponentfigure = 0;
matlabbatch{3}.spm.tools.nirsHSJ.M_dataComponent.E_extractcomponent.c_extractcomponent.b_extractnoise_PARAFAC.i_extract_pourcentagech = 5;
matlabbatch{3}.spm.tools.nirsHSJ.M_dataComponent.E_extractcomponent.c_extractcomponent.b_extractnoise_PARAFAC.i_extractnoise_nbPARAFAC = 5;
...
matlabbatch{4}.spm.tools.nirsHSJ.M_dataComponent.E_substractcomponent.i_substractcomponent_label = 'MVTPARAFAC';
