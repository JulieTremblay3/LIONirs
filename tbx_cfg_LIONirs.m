...
m_TtestOneSample.help = {'Use 2 tail or one tail assomption'};
...
m_TtestOneSample_matrix.help   = {'Use one tail or two tail ttest.'};
...
e_TtestOneSampleGR.help    = {['Enter the group to apply the one sample ttest (refer to groupe value in the xls file)']}; 
